...
{
    public class ParaviewIsogeometricSurfaces
    {
        private readonly Model _model;
        private readonly IVectorView _solution;
        private readonly string _filename;

        public ParaviewIsogeometricSurfaces(Model model, IVectorView solution, string filename)
        {
            _model = model;
            _solution = solution;
            _filename = filename;
        ...
        public void CreateParaviewFile()
        {
            ...
            foreach (var element in _model.Elements.Where(x => !(x.ElementType is PenaltyDofPair)))
            {
                ...
                var elementPoints = elementType.CalculatePointsForPostProcessing(element);
            ...
            var elementConnectivity = CreateConnectivity();
            ...
            WriteParaviewFile(nodes, elementConnectivity, pointDisplacements);
        }
