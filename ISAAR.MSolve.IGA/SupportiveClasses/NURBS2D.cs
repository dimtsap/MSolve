...
namespace ISAAR.MSolve.IGA.Problems.SupportiveClasses
{
    public class NURBS2D
    {
        ...
        public NURBS2D(int degreeKsi, int degreeHeta, Vector knotValueVectorKsi, Vector knotValueVectorHeta, NaturalPoint collocationPoint, IList<ControlPoint> controlPoints, bool calculateAllFunctions)
        {
            var numberOfControlPointsHeta = knotValueVectorHeta.Length - degreeHeta - 1;
