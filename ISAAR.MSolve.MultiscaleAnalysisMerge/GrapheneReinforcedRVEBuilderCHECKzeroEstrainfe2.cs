...
{
    public class GrapheneReinforcedRVEBuilderCHECKzeroEstrainfe2 : IRVEbuilder
    {
        public GrapheneReinforcedRVEBuilderCHECKzeroEstrainfe2()
        { }
        ...
        private static Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample1000withRenumberingwithInput_forMS()
        {
            ...
            string renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integrationZeroEstrainfe2\REF_new_total_numbering.txt";
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integrationZeroEstrainfe2\Fxk_p_komvoi_rve.txt";
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integrationZeroEstrainfe2\o_xsunol_gs_{0}.txt";
            int subdiscr1 = 1;
            int discr1 = 3;
            ...
            mp = mpgp.Item1; mp.hexa1 = 3; mp.hexa2 = 3; mp.hexa3 = 3;
            gp = mpgp.Item2;
            gp.E_shell = 0.000001;
