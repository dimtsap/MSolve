...
{
    public class GrapheneReinforcedRVEBuilderExample5GrSh1RVEstifDegenAndLinearPeripheral : IdegenerateRVEbuilder
    {
        //PROELEFSI GrapheneReinforcedRVEBuilderExample5GrSh1RVEstifDegenAndLinear
        // allages: boundary nodes mono ta peripheral (antistoixh xrhsh FEMMeshbuider)
        ...
        public GrapheneReinforcedRVEBuilderExample5GrSh1RVEstifDegenAndLinearPeripheral()
        { }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample5GrSh1RVEstifDegenAndLinearPeripheral();
