...
{
    public class HomogeneousRVEBuilderCheck27HexaDegenerateAndLinearPeripheral : IdegenerateRVEbuilder
    {
        ...
        public HomogeneousRVEBuilderCheck27HexaDegenerateAndLinearPeripheral()
        {
            //TODOGerasimos
