...
{
    public class Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrains3D : StructuralProblemsMicrostructureBase, IContinuumMaterial3D
    {
        //PROELEFSI: Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrains2D.cs
        //Allages: profanws prosarmogh se 3D
        ...
        private IScaleTransitions scaleTransitions = new SmallStrain3DScaleTransition(); //TODO: mporoume na to dinoume ston constructor
        ...
        public Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrains3D(IRVEbuilder rveBuilder)
        {
        ...
        {
            return new Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrains3D(rveBuilder);
        }
        ...
        public void UpdateMaterial(StressStrainVectorContinuum3D smallStrainVec)
        {
        ...
        public ElasticityTensorContinuum3D ConstitutiveMatrix
        {
            get
            {
                if (constitutiveMatrix == null) UpdateMaterial(new StressStrainVectorContinuum3D( new double[6])); // TODOGerasimos arxiko constitutive mporei na upologizetai pio efkola
                return new ElasticityTensorContinuum3D( constitutiveMatrix.Data); // TODO: apla kratame to constitutive matrix san array[,] (alla matrix mporei na xrhimopoithei gia tis peristrofes)
            }
        }

        public StressStrainVectorContinuum3D Stresses // opws xrhsimopoeitai sto mohrcoulomb kai hexa8
        {
            get { return  new StressStrainVectorContinuum3D(trueStressVec); }
        }
