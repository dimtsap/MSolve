...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    public class Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShell : StructuralProblemsMicrostructureBase, IShellMaterial //A.1
    {
        ...
        public Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShell(IdegenerateRVEbuilder rveBuilder)
        {
        ...
        {
            return new Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShell(rveBuilder);
        }
        ...
        public void UpdateMaterial(double[] smallStrainVec)
        {
            ...
            this.TransformStrains(smallStrainVec);
            ...
            StressesAndConstitutiveMatrixTransformation(trueStressVec, constitutiveMat);
            #endregion
        ...
        private void TransformStrains(double[] smallStrainVec)
        {
            smallStrainVec = ((transformationMatrix *(new Vector( smallStrainVec))).Data);
        }


        private void StressesAndConstitutiveMatrixTransformation( double[] trueStressVec, double[,] constitutiveMat)
        {            
            trueStressVec = (transformationMatrix.Transpose() * (new Vector(trueStressVec))).Data;
            // TODO: CHECK matrix for corrupted data after multiplication
            constitutiveMat = (transformationMatrix.Transpose() * (new Matrix2D(constitutiveMat)) * transformationMatrix).Data;
        }
