...
{
    public class ProblemStructuraliga : IImplicitIntegrationProvider, IStaticProvider, INonLinearProvider
    {
        ...
        public ProblemStructuraliga(IStructuralModel model, IDictionary<int, ILinearSystem> subdomains)
        {
            this.model = model;
        ...
        public void Reset()
        {
            foreach (Patch subdomain in model.ISubdomainsDictionary.Values)
